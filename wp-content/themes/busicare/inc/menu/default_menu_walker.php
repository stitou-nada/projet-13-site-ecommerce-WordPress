<?php 
function busicare_page_menu_args( $args ) {
	if ( ! isset( $args['show_home'] ) )
		$args['show_home'] = true;
	return $args;
}
add_filter( 'wp_page_menu_args', 'busicare_page_menu_args' );
function busicare_fallback_page_menu( $args = array() ) {
	...
	$list_args['title_li'] = '';
	$list_args['walker'] = new Busicare_walker_page_menu;
...
class Busicare_walker_page_menu extends Walker_Page{
